...
export const domain={
 ...
 tagline:'让风险决策更快，也让每次拦截有据可查',storyTitle:'模型负责发现可疑行为，<br/>调查人员负责最终判断',storyText:'将实时评分、增强验证与人工调查串成闭环，兼顾交易安全、客户体验和合规审计。',pattern:[2,5,7,10,13,16,18,21,24,27,31],loginStats:[['86,420','今日交易'],['78.6%','自动处置率'],['32','待调查事件']],loginTitle:'交易风险控制中心',adminDemo:'风险 / 策略 / 调查',fieldDemo:'事件 / 证据 / 处置',upgrade:{eyebrow:'V1.1 关联风控',title:'账户—设备—IP 关联网络分析',summary:'从共享设备、共享网络和高风险邻居发现团伙聚集，输出调查优先级与可解释证据。',api:'POST /api/ai/fraud/link-risk',metrics:[['74','网络风险分'],['18','观测关联'],['P4','调查优先级']]}
}
