...
@Configuration public class DataInitializer {
 ...
 var t2=orders.save(new WorkRecord("FR-260804-021","ATO-DEVICE","异地设备账户接管",u2,18,8,0,LocalDate.now().plusDays(2),WorkRecord.Status.RUNNING,"调查证据库"));
 var t3=orders.save(new WorkRecord("FR-260804-026","PROMO-ABUSE","营销优惠套利",u1,12,0,0,LocalDate.now().plusDays(3),WorkRecord.Status.RELEASED,"决策引擎"));
 var t4=orders.save(new WorkRecord("FR-260803-015","REFUND-RISK","商户退款异常",u3,20,20,1,LocalDate.now(),WorkRecord.Status.COMPLETED,"风险档案"));
 resources.saveAll(List.of(new ResourceRegister("CONNECTOR-01","实时特征服务",u1,ResourceRegister.Status.RUNNING,98),new ResourceRegister("HYBRID-INDEX-02","混合检索分析",u2,ResourceRegister.Status.IDLE,91),new ResourceRegister("RERANK-03","关联图谱服务",u3,ResourceRegister.Status.RUNNING,93),new ResourceRegister("ACL-FILTER-04","自动决策护栏",u1,ResourceRegister.Status.ALARM,84)));
